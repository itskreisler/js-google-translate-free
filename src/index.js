 ...
 *
 */
var GoogleTranslate = /*#__PURE__*/function () {
  ...
  _createClass(GoogleTranslate, null, [{
     ...
     */
    function () {
      var _translate = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee() {
        var options,
          from,
          to,
          text,
        ...
        return _regeneratorRuntime().wrap(function _callee$(_context) {
          while (1) switch (_context.prev = _context.next) {
            ...
            case 7:
              _context.next = 9;
              return GoogleTranslate.requestTranslation(source, to, text);
            case 9:
    ...
    value: (function () {
      var _requestTranslation = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee2(source, target, text) {
      ...
      function requestTranslation(_x, _x2, _x3) {
...
var ErrorStringFromGoogleTranslate = /*#__PURE__*/function (_Error) {
  _inherits(ErrorStringFromGoogleTranslate, _Error);
  function ErrorStringFromGoogleTranslate(message) {
    var _this;
    _classCallCheck(this, ErrorStringFromGoogleTranslate);
    _this = _callSuper(this, ErrorStringFromGoogleTranslate, [message]);
    _this.name = 'ErrorStringFromGoogleTranslate';
    return _this;
  }
  return _createClass(ErrorStringFromGoogleTranslate);
}( /*#__PURE__*/_wrapNativeSuper(Error));
var ErrorStringToGoogleTranslate = /*#__PURE__*/function (_Error2) {
  _inherits(ErrorStringToGoogleTranslate, _Error2);
  function ErrorStringToGoogleTranslate(message) {
    var _this2;
    _classCallCheck(this, ErrorStringToGoogleTranslate);
    _this2 = _callSuper(this, ErrorStringToGoogleTranslate, [message]);
    _this2.name = 'ErrorStringToGoogleTranslate';
    return _this2;
  }
  return _createClass(ErrorStringToGoogleTranslate);
}( /*#__PURE__*/_wrapNativeSuper(Error));
var ErrorStringTextGoogleTranslate = /*#__PURE__*/function (_Error3) {
  _inherits(ErrorStringTextGoogleTranslate, _Error3);
  function ErrorStringTextGoogleTranslate(message) {
    var _this3;
    _classCallCheck(this, ErrorStringTextGoogleTranslate);
    _this3 = _callSuper(this, ErrorStringTextGoogleTranslate, [message]);
    _this3.name = 'ErrorStringTextGoogleTranslate';
    return _this3;
  }
  return _createClass(ErrorStringTextGoogleTranslate);
}( /*#__PURE__*/_wrapNativeSuper(Error));
